    ...
    public static List<CourseModel> parse(String parseString) {
        ...
        try {
            ...
            for(int i=0;i<array.length();i++){
                ...
                if(array2.length()<=10){
                    courses.add(new CourseModel(term,name,null, teacher, null, -1, -1, -1, -1,null));
                    continue;
                }
                ...
                courses.add(new CourseModel(term,name, room, teacher, getWeekList(weeks), start, step, day, -1,null));
            }
